...
class NewsFeed extends Component {
  ...
  componentDidMount() {
    setTimeout(() => {
      if (this.props.isAuthenticated) {
        ...
        axios
          .get(baseURL + "/vendor/newsfeed/" + this.props.vendor._id, config)
          .then(response => {
            this.setState({
              items: response.data
            });
  ...
  handleAcceptance(item_id) {
    ...
    axios
      .post(
        baseURL + "/vendor/" + this.props.vendor._id + "/acceptOffer",
        body,
        config
      )
      .then(response => {
  ...
  handleRejection(item_id) {
    ...
    axios
      .post(
        baseURL + "/vendor/" + this.props.vendor._id + "/rejectOffer",
        body,
        config
      )
      .then(response => {
...
export default connect(mapStateToProps, { clearErrors })(NewsFeed);
